...
%prep
%setup -q -n pyfilesystem2-2.4.14
cd %{_builddir}/pyfilesystem2-2.4.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637086941
...
cp %{_builddir}/pyfilesystem2-2.4.14/LICENSE %{buildroot}/usr/share/package-licenses/fs/10348835a1c433da486e7a1817c886e19efd0624
