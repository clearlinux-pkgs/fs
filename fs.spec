...
%prep
%setup -q -n pyfilesystem2-2.4.12
cd %{_builddir}/pyfilesystem2-2.4.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610648948
...
cp %{_builddir}/pyfilesystem2-2.4.12/LICENSE %{buildroot}/usr/share/package-licenses/fs/10348835a1c433da486e7a1817c886e19efd0624
