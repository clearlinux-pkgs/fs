...
Source0  : https://github.com/PyFilesystem/pyfilesystem2/archive/v2.4.15/pyfilesystem2-2.4.15.tar.gz
...
%prep
%setup -q -n pyfilesystem2-2.4.15
cd %{_builddir}/pyfilesystem2-2.4.15
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644247383
...
cp %{_builddir}/pyfilesystem2-2.4.15/LICENSE %{buildroot}/usr/share/package-licenses/fs/10348835a1c433da486e7a1817c886e19efd0624
