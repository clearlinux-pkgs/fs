...
Source0  : https://github.com/PyFilesystem/pyfilesystem2/archive/v2.4.7/pyfilesystem2-2.4.7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1560012655
export AR=gcc-ar
